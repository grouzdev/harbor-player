...
const formats = {
  ...
  flac: ["-c:a", "flac"],
  m4a: ["-c:a", "aac"],
  aac: ["-c:a", "aac", "-f", "adts", "-write_id3v2", "1"],
  ogg: ["-c:a", "libvorbis"],
  opus: ["-c:a", "libopus"],
  wav: ["-c:a", "pcm_s16le"],
};
for (const [extension, flags] of Object.entries(formats)) {
  execFileSync(ffmpeg, [
    ...
    "disc=1/2",
    "-metadata",
    "comment=Не менять комментарий",
    "-metadata",
    "CUSTOM_TEST=Сохранить неизвестное поле",
...
execFileSync(ffmpeg, [
  ...
  "title=ID3 v2.4",
  "-metadata",
  "CUSTOM_TEST=Неизвестный тег",
  path.join(root, "id3v24.mp3"),
]);
execFileSync(ffmpeg, [
  "-hide_banner",
  "-loglevel",
...
execFileSync(ffmpeg, [
  ...
  "lavfi",
  "-i",
  "color=c=0x2c615c:s=1200x1200",
  "-vf",
  "noise=alls=100:allf=t",
  "-frames:v",
  "1",
  path.join(root, "large-cover.png"),
]);
